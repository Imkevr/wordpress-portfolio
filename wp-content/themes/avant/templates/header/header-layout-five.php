...
<header id="masthead" class="site-header site-header-layout-five <?php echo ( get_theme_mod( 'avant-header-switch' ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?> <?php echo ( is_front_page() && get_theme_mod( 'avant-header-remove-slider-space' ) ) ? sanitize_html_class( 'site-header-nospace' ) : ''; ?>">
